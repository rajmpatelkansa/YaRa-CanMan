                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                                ...
                                <input type="email" class="form-control" id="email" name="email" placeholder="Enter Your Email" required value="<?php if(isset($_SESSION['userId'])){echo $email;}?>">
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="phone" name="phone" aria-describedby="basic-addon" placeholder="Enter Your Phone Number" required pattern="[0-9]{10}" value="<?php if(isset($_SESSION['userId'])){echo $phone;}?>">
                                </div>
                            </div>
                          </div>
                          <div class="col-lg-6">
